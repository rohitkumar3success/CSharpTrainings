...
namespace Eventmgr
{
	...
	abstract class Eventmngr    // PARENT CLASS ALONG WITH ABSTARCT CLASS
	{
...

{
	...
	interface ICeremony     //implementation of interafce
	{

		void Ceremony();        // method implented with empty body
	...
	class Program
	{
		...
		label:
...

			{
				...
				Console.WriteLine("Enter the time of the event: ");
				...
				Console.
						WriteLine("Select the packageoffer you want for the event");

				Console.WriteLine("Select for Platinum packageoffer");

				Console.WriteLine("Select for Gold packageoffer");

				Console.WriteLine("Select  for Silver packageoffer");
...

			{
				...
				Console.
						WriteLine
						("Here's the details of the event you are planning for:\n");
...

			{
				...
				Console.WriteLine("Your Total totalexpenditure is: " +
								obj1.totalexpenditure);
